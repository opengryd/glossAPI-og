...
export GLOSSAPI_DEEPSEEK_OCR_ENABLE_MLX_OCR=1
export GLOSSAPI_DEEPSEEK_OCR_ENABLE_STUB=0
export GLOSSAPI_VLM_RENDER_PREFETCH=2
export GLOSSAPI_VLM_MAX_TOKENS=4096
export GLOSSAPI_DEEPSEEK_OCR_MAX_TOKENS=4096
...
export GLOSSAPI_VLM_RENDER_PREFETCH=2
export GLOSSAPI_VLM_MAX_TOKENS=4096
export GLOSSAPI_DEEPSEEK2_MAX_TOKENS=4096
export GLOSSAPI_SKIP_DOCLING_BOOT=1
EOF
...
export GLOSSAPI_OLMOCR_DEVICE="mps"
export GLOSSAPI_VLM_RENDER_PREFETCH=2
export GLOSSAPI_VLM_MAX_TOKENS=2048
export GLOSSAPI_OLMOCR_MLX_MAX_TOKENS=2048
export GLOSSAPI_SKIP_DOCLING_BOOT=1
EOF
...
export GLOSSAPI_VLM_MAX_TOKENS=2048
export GLOSSAPI_OLMOCR_MAX_TOKENS=2048
export GLOSSAPI_SKIP_DOCLING_BOOT=1
EOF
    if [[ -n "${GLOSSAPI_OLMOCR_LD_LIBRARY_PATH:-}" ]]; then
...
export GLOSSAPI_VLM_RENDER_PREFETCH=2
export GLOSSAPI_VLM_MAX_TOKENS=2048
export GLOSSAPI_GLMOCR_MAX_TOKENS=2048
export GLOSSAPI_SKIP_DOCLING_BOOT=1
EOF
...
export GLOSSAPI_MINERU_COMMAND="${GLOSSAPI_MINERU_COMMAND:-}"
export GLOSSAPI_MINERU_MODE="auto"
export GLOSSAPI_MINERU_DEVICE_MODE="${MINERU_DEVICE_MODE_DEFAULT}"
